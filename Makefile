...
BSDCC = clang
CC = gcc
CFLAGS += -std=c99 -shared -Wno-bitwise-op-parentheses -fPIC -O3
...
arm64: pcrypt.c shuffle2.c unshuffle.c unshuffle2.c
	$(ARM64CC) $(CFLAGS) -o libpcrypt-linux-arm32.so pcrypt.c

mac32: pcrypt.c shuffle2.c unshuffle.c unshuffle2.c
	$(BSDCC) $(CFLAGS) -m32 -mmacosx-version-min=10.5 -o libpcrypt-macos-i386.dylib pcrypt.c

mac64: pcrypt.c shuffle2.c unshuffle.c unshuffle2.c
	$(BSDCC) $(CFLAGS) -m64 -march=core2 -mmacosx-version-min=10.7 -o libpcrypt-macos-x86-64.dylib pcrypt.c

bsd32: pcrypt.c shuffle2.c unshuffle.c unshuffle2.c
	$(BSDCC) $(CFLAGS) -m32 -o libpcrypt-freebsd-i386.so pcrypt.c

bsd64: pcrypt.c shuffle2.c unshuffle.c unshuffle2.c
	$(BSDCC) $(CFLAGS) -m64 -o libpcrypt-freebsd-x86-64.so pcrypt.c
