...
public:
  ...
  If assert() or the Twofish_fatal function is not called, the code passed the
  test. (See the twofish.c file for details on the Twofish_fatal function.)
  */
  Twofish();
  ...
  */
  void PrepareKey(const Twofish_Byte aKeyBytes[], int aKeyLength,
                  TwofishKey *aKey);
  ...
  */
  void Encrypt(const TwofishKey *aKey, const Twofish_Byte aPlainText[16],
               Twofish_Byte aCipherText[16]);
  ...
  */
  void Decrypt(const TwofishKey *aKey, const Twofish_Byte aCipherText[16],
               Twofish_Byte aPlainText[16]);

private:
  void test_vector(Twofish_Byte key[], int key_len, Twofish_Byte p[16],
                   Twofish_Byte c[16]);
  void test_vectors();
